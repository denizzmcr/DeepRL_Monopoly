...
POLICIES = {
    "stu_512a":  f"ppo:{D}/student_c1_h512.pt",
    "stu_1024":  f"ppo:{D}/student_c2_h1024.pt",
    "stu_256":   f"ppo:{D}/student_c3_h256.pt",
    "stu_512b":  f"ppo:{D}/student_c4_h512.pt",
    "fast":      f"ppo:{REPO}/artifacts/LAST_RESORT.pt",
    "champion":  f"ppo:{REPO}/artifacts/CHAMPION.pt",
    "kuzey":     "kuzey",
}
SEEDS = 4
WORKERS = 11
OUT = Path(__file__).with_name("screen.json")
