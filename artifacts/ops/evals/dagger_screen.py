...
POLICIES = {
    "v1_256":   f"ppo:{D}/student_c3_h256.pt",
    "v2_256":   f"ppo:{D}/student2_c3_h256.pt",
    "v2_512a":  f"ppo:{D}/student2_c1_h512.pt",
    "v2_512b":  f"ppo:{D}/student2_c4_h512.pt",
    "v2_1024":  f"ppo:{D}/student2_c2_h1024.pt",
    "fast":     f"ppo:{REPO}/artifacts/LAST_RESORT.pt",
    "kuzey":    "kuzey",
}
SEEDS = 4
WORKERS = 11
OUT = Path(__file__).with_name("dagger_screen.json")
