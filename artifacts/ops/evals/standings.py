...
POLICIES = {
    "fast":     f"ppo:{REPO}/artifacts/LAST_RESORT.pt",      # laptop fast league, 47.5k games
    "champion": f"ppo:{REPO}/artifacts/CHAMPION.pt",         # current submission, 256-wide
    "asu512":   f"ppo:{CKPT}/v2_h512_a2_g001512.pt",         # ASU league, 512-wide
    "asu1024":  f"ppo:{CKPT}/v2_h1024_a1_g001512.pt",        # ASU league, 1024-wide
    "asu":      "asu-value-v1",                              # the benchmark
    "kuzey":    "kuzey",                                     # anti-ASU heuristic
}
SEEDS = 8
WORKERS = 11
